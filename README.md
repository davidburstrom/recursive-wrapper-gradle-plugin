...
What if it was possible to run `./gradlew :wrapper --gradle-version=8.2-rc-2` in the root project
...
The plugin has been tested on all Gradle versions from 6.0.1 to 8.2-rc-2.
